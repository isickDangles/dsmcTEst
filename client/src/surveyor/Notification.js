...
import { Container, TextField, Button, Typography, Box, Paper, List, ListItem, ListItemText, IconButton, Grid, CardContent, Card, } from '@mui/material';
                ...
                <Card sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', minHeight: 80 }}>
                  ...
                  <CardContent>
                    ...
                    <Button variant="contained" color="secondary" startIcon={<SendIcon />} style={{ marginLeft: '10px' }}
                      onClick={() => navigate(`/email-notification/${survey.surveytemplateid}`)}
                    >
                      Send
                    </Button>
                  </CardContent>
